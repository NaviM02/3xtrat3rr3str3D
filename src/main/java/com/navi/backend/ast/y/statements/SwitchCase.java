...
@Getter
public class SwitchCase extends AstYNode {
    private final Expression expression;
    private final List<Statement> statements;
    private final BreakStatement breakStatement;

    public SwitchCase(int line, int column, Expression expression, List<Statement> statements, BreakStatement breakStatement) {
        super(line, column);
